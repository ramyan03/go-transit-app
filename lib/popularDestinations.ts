...
export const POPULAR_DESTINATIONS: PopularDestination[] = [
  ...
  // Shopping
  { id: "yorkdale",      name: "Yorkdale Mall",          emoji: "🛍️", goStopId: "DW",  goStopName: "Downsview Park GO" },
  { id: "vaughan_mills", name: "Vaughan Mills",          emoji: "🛍️", goStopId: "RU",  goStopName: "Rutherford GO" },
  { id: "square_one",    name: "Square One",             emoji: "🛍️", goStopId: "PO",  goStopName: "Port Credit GO" },
  { id: "sherway",       name: "Sherway Gardens",        emoji: "🛍️", goStopId: "LO",  goStopName: "Long Branch GO" },
  ...
  // Other destinations
  { id: "niagara_falls", name: "Niagara Falls",          emoji: "💦", goStopId: "NI",  goStopName: "Niagara Falls GO",     note: "Weekend service only" },
